...
describe("Gilded Rose", function () {
  it("should foo", function () {
    ...
    const items = gildedRose.updatedQuality();
  ...
  describe("Conjured", function () {
    it("should decrease the sellIn value and quality of the conjured item by -2 each day", function () {
      const gildedRose = new Shop([new Item("Conjured", 10, 10)]);
      const items = gildedRose.updatedQuality();
      expect(items[0].sellIn).toEqual(9);
      expect(items[0].quality).toEqual(8);
    });
    it("should decrease the quality by -4 as each day goes by and sellIn value is below 0", function () {
